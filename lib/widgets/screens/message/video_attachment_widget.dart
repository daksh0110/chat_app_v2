...
import 'package:my_app/widgets/screens/message/inline_video_player.dart';

class VideoAttachmentWidget extends ConsumerWidget {
  final MediaTableData media;

  const VideoAttachmentWidget({super.key, required this.media});
          ...
          onTap: () {
            showDialog(
              ...
              builder: (_) => Dialog(
                ...
                child: InlineVideoPlayer(path: media.location!),
              ),
            );
          },
          child: Container(
            ...
            child: Stack(
              ...
              children: [
                const Icon(LucideIcons.video, size: 48, color: Colors.white24),
